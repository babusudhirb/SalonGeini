...
function marketing() {
  ...
  const marketingGrowthPlatform = document.getElementById('marketing-growth-platform');
  if (marketingGrowthPlatform) { marketingGrowthPlatform.onclick = () => { window.location.href = 'growth-platform.html'; }; marketingGrowthPlatform.onkeydown = event => { if (event.key === 'Enter' || event.key === ' ') marketingGrowthPlatform.click(); }; }
